...
| NoSQL (no joins, no SQL) | DynamoDB (~JSON), ElastiCache (key/value), Neptune (graphs), DocumentDB (for MongoDB), Keyspaces (for Cassandra) |
| Object Store | S3 (big objects) / Glacier (backups / archives) |
| Data Warehouse (SQL Analytics / BI) | Redshift (OLAP), Athena, EMR |
| Search | OpenSearch (JSON) – free text, unstructured searches |
| Graphs | Amazon Neptune – relationships between data |
...
- Can replace ElastiCache as a key/value store (storing session data, using TTL feature)
- Highly Available, Multi AZ by default, Read and Writes are decoupled, transaction capability
- DAX cluster for read cache, microsecond read latency
- Security, authentication, and authorization done through IAM
...
- Build and run applications working with highly connected datasets – optimized for complex, hard queries
...
- Data storage tiering: recent data kept in memory; historical data kept in a cost-optimized storage
- Built-in time-series analytics functions (identify patterns in your data in near real-time)
- Encryption in transit and at rest
- **Use cases:** IoT apps, operational applications, real-time analytics

### Amazon Timestream – Architecture

Amazon Timestream integrates with:
- **Data ingestion:** AWS IoT, Kinesis Data Streams, Amazon MSK, Kinesis Data Analytics (Apache Flink), Lambda, Prometheus
- **Data consumption:** Amazon QuickSight, Amazon SageMaker, any JDBC connection
